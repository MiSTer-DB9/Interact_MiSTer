...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Interact_MiSTer.git"
CORE_NAME=(Interact)
...
UPSTREAM_CORE_NAME=(Interact)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Interact.qpf)
COMPILATION_OUTPUT=(output_files/Interact.rbf)
